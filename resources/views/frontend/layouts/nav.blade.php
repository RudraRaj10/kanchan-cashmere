             ...
             <div class="container-fluid">
                 <div class="row">
                     ...
                     <div class="col-lg-2 pane-image-column">
                         <img src="{{ asset('frontend/assets/images/accessories-collection/DSC04306.jpg') }}" alt="" />
                     </div>
                     <div class="col-lg-2 pane-image-column">
                         <img src="{{ asset('frontend/assets/images/men-collection/DSC04415.jpg') }}" alt="" />
                     </div>
                 </div>
             </div>
         </div>
         ...
         <div class="pane" id="women-pane">
             <div class="container-fluid">
                 <div class="row">
                     ...
                     <div class="col-lg-2 pane-image-column">
                         <img src="{{ asset('frontend/assets/images/women-collection/DSC03656.jpg') }}" alt="" />
                     </div>
                 </div>
             </div>
         </div>
         ...
         <div class="pane" id="men-pane">
             <div class="container-fluid">
                 <div class="row">
                     ...
                     <div class="col-lg-2 pane-image-column">
                         <img src="{{ asset('frontend/assets/images/men-collection/men3.jpg') }}" alt="" />
                     </div>
                 </div>
             </div>
         </div>
         ...
         <div class="pane" id="accessories-pane">
             <div class="container-fluid">
                 <div class="row">
                     ...
                     <div class="col-lg-2 pane-image-column">
                         <img src="{{ asset('frontend/assets/images/accessories-collection/DSC04352.jpg') }}" alt="" />
                     </div>
                     <div class="col-lg-2 pane-image-column">
                         <img src="{{ asset('frontend/assets/images/accessories-collection/DSC04357.jpg') }}" alt="" />
                     </div>
                 </div>
             </div>
         </div>
